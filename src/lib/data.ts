...
export const DATASETS: DatasetMeta[] = [
  {
    ...
    file: '4.生成式AI对大学生影响的调查-2246_analysis.json',
    records: 2246,
    fields: 75,
  ...
  },
  {
    ...
    file: '5.生成式AI对大学生学习方式的影响-915_analysis.json',
    records: 915,
    fields: 91,
  ...
  },
  {
    ...
    file: '1.校园巴士服务调查2025春-695_analysis.json',
    records: 695,
    fields: 149,
    source: '问卷星 23072848',
    preloaded: true,
  },
  {
    ...
    file: '2.校园巴士服务调查方案调整-555_analysis.json',
    records: 555,
    fields: 187,
    source: '问卷星 23072874',
    preloaded: true,
  },
  {
    ...
    file: '3.课堂专注力调查-39_analysis.json',
    records: 39,
    fields: 25,
    source: '问卷星 25162701',
    preloaded: true,
  },
  {
    ...
    file: '6.智能学习IDE插件需求调查-63_analysis.json',
    records: 63,
    fields: 26,
  ...
  },
  {
    ...
    file: '7.DecoLounge留学群聊需求调查-79_analysis.json',
    records: 79,
    fields: 31,
